...
SUGGESTION_STUDENT_ADVISOR: str = "\nIt's understandable that you don't want to share it with other students. \nIn this case we suggest contacting Student Advisor.\n"
SUGGESTION_STUDENT_DESK: str = "\nAll practical informations are available at our Student Desk. \nIn this case you should reach out to them :)\n"
SUGGESTION_SPORTS_CENTRE: str = "\nGood news! \n{sport} is available at our university! \nWe advise you to contact Sport Centre website to find out more.\n"
